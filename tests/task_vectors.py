...
task_vector = create_task_vector("saves_pretrained_weights/lora/llama-3.2-1b-instruct/pretrained_weights_42", "saves_bts_preliminary/lora/llama-3.2-1b-instruct/train_qnli_42_1773148413")
model = task_vector.apply_to("saves_pretrained_weights/lora/llama-3.2-1b-instruct/pretrained_weights_42", scaling_coef=1.0, args={"device": "cpu"})
# print(task_vector.vector["base_model.model.model.layers.9.self_attn.v_proj.lora_A.weight"])
model.save_pretrained("test")


model1 = AutoModelForCausalLM.from_pretrained("saves_bts_preliminary/lora/llama-3.2-1b-instruct/train_qnli_42_1773148413")
model2 = AutoModelForCausalLM.from_pretrained("test")
model3 = AutoModelForCausalLM.from_pretrained("saves_pretrained_weights/lora/llama-3.2-1b-instruct/pretrained_weights_42")
